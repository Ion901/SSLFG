...
<head>
    ...
    @section('stylesheets')
        ...
        <!-- YearPicker CSS -->
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/saravanajd/YearPicker@1.1.0/dist/yearpicker.css" />
    ...
    @section('scripts')
        ...
        <!-- jQuery (must load before yearpicker) -->
        ...
        <!-- YearPicker plugin (must load after jQuery) -->
        <script src="https://cdn.jsdelivr.net/gh/saravanajd/YearPicker@1.1.0/dist/yearpicker.js"></script>
